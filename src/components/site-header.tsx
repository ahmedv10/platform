...
export function SiteHeader() {
  ...
  return <header className="site-header">
    <Link className="brand" href="/" aria-label="OYOON ALTAQNYA home"><span className="brand-symbol"><i /><i /><i /></span><span>OYOON ALTAQNYA<span className="brand-dot">.</span></span></Link>
